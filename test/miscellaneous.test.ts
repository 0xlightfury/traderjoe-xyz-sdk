...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    ...
    const pair = new Pair(new TokenAmount(tokenA, '0'), new TokenAmount(tokenB, '0'), CHAIN_ID)
  ...
  it('getLiquidityMinted:!0', async () => {
    const tokenA = new Token(CHAIN_ID, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(CHAIN_ID, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(new TokenAmount(tokenA, '10000'), new TokenAmount(tokenB, '10000'), CHAIN_ID)
  ...
  it('getLiquidityValue:!feeOn', async () => {
    const tokenA = new Token(CHAIN_ID, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(CHAIN_ID, '0x0000000000000000000000000000000000000002', 18)
    const pair = new Pair(new TokenAmount(tokenA, '1000'), new TokenAmount(tokenB, '1000'), CHAIN_ID)
